...
function loadProvinceData(province)
{
	...
	xhttp.onreadystatechange = function() {
		...
		//Well. all those "HTML" pages are not really "Partial" html pages. And script tags are not gonna be loaded.
		//From those province pages you mean?kinda. I figured :P Besides that most stuff works, so what you could do...is..
	};
